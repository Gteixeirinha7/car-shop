...
@WebServlet("/instalador/api/is-action-valid")
public class APIActionValid extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(!inputData.containsKey("id") || !inputData.containsKey("token")){
            ...
            response.getWriter().append(
                security.isActionValid(actionId, actionToken).toString()
            );
