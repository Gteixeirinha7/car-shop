...
@WebServlet("/instalador/api/signin")
public class APISignIn extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(!inputData.containsKey("email") || !inputData.containsKey("password")){
            ...
            response.getWriter().append(
                security.signIn(email, password).toString()
            );
